 ...
 *
 * Edited by: Wyvest
 * Edited on: 2023-09-25
 * Edited Comment: Change Craftify branding to SkyClientUpdater
 */
...
import static mynameisjeff.skyblockclientupdater.utils.ssl.LambdaExceptionUtils.rethrowBiConsumer;
import static mynameisjeff.skyblockclientupdater.utils.ssl.LambdaExceptionUtils.rethrowFunction;
...
public class FixSSL {
    ...
    public static void fixup() {
        try {
            ...
            context = tls;
            System.out.println("[SkyClientUpdater]: Added Lets Encrypt root certificates as additional trust");
        } catch (KeyStoreException | IOException | NoSuchAlgorithmException | CertificateException | KeyManagementException e) {
            System.out.println("[SkyClientUpdater]: Failed to load lets encrypt certificate. Expect problems");
            e.printStackTrace();
        }
